...
-   **A empresa gestiona os dados**
    ...
    Vs Você é a responsável <!-- Google drive, por exemplo -->

## Mas e o que isso tem de mais?

-   Tudo em um **único app**
-   Organiza **todas suas referências**
...
-   Formatação recomendada: [**Planeta
    Zotero**](https://planetazotero.blogspot.com/2020/04/estilo-da-norma-abnt-2018-para-o-zotero.html)

-   [**Docs**](https://www.youtube.com/watch?v=YA-Lq0VpvQA)
    <!-- Elaborar vídeo, lembrar de mencionar o lance de como precisa de cópia para docs colaborativo -->

-   [**Word**](https://youtu.be/wgz2QF4JUD0?si=MqsR6aL860-Cgbcv)\
    [Vídeo Aula para o Fix do
    Plugin](https://youtu.be/6GTqQU-8jcM?si=_d6J2ZUyILEj5Unl&t=140)

## Corrigindo o Word

::: {style="display: flex; align-items: center;"}
<img src="FixWord.gif" alt="FixWord" style="max-width: 80%; height: auto;"/>

::: {style="font-size: 0.8em; padding-left: 0px;"}
```         
Em resumo:

Ir ao endereço: C:\Program Files (x86)\Zotero\integration\word-for-windows

Copiar o arquivo Zotero.dotm

Apertar tecla Windows > %appdata% > microsoft > word > startup > colar arquivo
```
:::
:::
...
<img src="zotfilerename.gif" alt="zotrename" width="560"/>
<!-- Verificar se animacao gif corrigiu -->
